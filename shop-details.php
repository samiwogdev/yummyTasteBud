        ...
        <div class="row">
            ...
            <div class="col-xl-7 col-lg-7 col-md-7">
                <div class="shop-detail">
                    ...
                    <div class="wiselist">
                        <ul class="compare">
                            <li><a href="shop-details"><i class="fa fa-heart" aria-hidden="true"></i> Wishlist </a></li>
                            <li><a href="shop-details"><i class="fa fa-signal" aria-hidden="true"></i> Compare</a></li>
                            <li><a href="shop-details"><i class="fa fa-envelope" aria-hidden="true"></i> Email to Friends</a></li>
                        </ul>
                        <ul class="share">
                            <li class="share-title">Share This :</li>
                            <li><a href="shop-details"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
                            <li><a href="shop-details"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
                            <li><a href="shop-details"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            <li><a href="shop-details"><i class="fa fa-instagram" aria-hidden="true"></i></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="comment-detail">
                                        ...
                                        <a href="shop-details" class="reply-btn btn btn-color small">Reply</a>
                                    </div>
