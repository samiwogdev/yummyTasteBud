    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2><i class="fas fa-cart-plus mr-2 text-warning"></i>Ongoing Order
                </h2>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card shadow ">
                    <div class="header">
                        <h2> <small>This option enables you to view all ongoing order </small></h2>
                    </div>
                </div>
            </div>
            <div class="col-12 p-5">
                <?php $all_new_orders = $order->getAllOngoingOrders(); ?>
                                    ...
                                    <td>
                                          <div class="dropdown" style="display: inline !important">
                                                <a class="dropdown-toggle" href="#" type="button" data-toggle="dropdown" aria-expanded="false">
                                                    <i class="fa fa-folder-open m-r-15 text-warning" title="attachment"></i>
                                                </a>
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item" href="../controller/order_status?n=3&shop_id=<?php echo $all_new_order['shop_id'] ?>&page=<?php echo $primary_page ?>"><i class="fa fa-cart-plus m-r-15 text-danger"></i>Canceled</a>
                                                </div>
                                            </div>
                                    </td> 
