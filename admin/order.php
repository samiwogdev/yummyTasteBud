    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-7 col-md-6 col-sm-12">
                <h2><i class="fa fa-shopping-bag mr-2 text-info"></i>New Order
                </h2>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card shadow ">
                    <div class="header">
                        <h2> <small>This option enables you to view all new orders </small></h2>
                    </div>
                </div>
            </div>
            <div class="col-12 p-5">
                <?php $all_new_orders = $order->getAllNewOrders(); ?>
                                    ...
                                    <td><?php echo $count ?></td> 
                                          ...
                                          <div class="dropdown" style="display: inline !important">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="../controller/order_status?n=1&shop_id=<?php echo $all_new_order['shop_id'] ?>&page=<?php echo $primary_page ?>"><i class="fa fa-cart-plus m-r-15 text-warning"></i>Ongoing</a>
                                                    <a class="dropdown-item" href="shop_image?n=2&shop_id=<?php echo $all_new_order['shop_id'] ?>&page=<?php echo $primary_page ?>"><i class="fa fa-cart-plus m-r-15 text-success"></i>Completed</a>
                                                    <a class="dropdown-item" href="shop_image?n=3&shop_id=<?php echo $all_new_order['shop_id'] ?>&page=<?php echo $primary_page ?>"><i class="fa fa-cart-plus m-r-15 text-danger"></i>Canceled</a>
                                                </div>
                                            </div>
                                    </td>
...
<?php if (isset($_GET['n']) && $_GET['n'] == "success") { ?>
