...
$page = "definition";
if (!isset($_GET['n'])) {
    header("location: settings?info=invalid");
}
        ...
        <div class="row">
              <div class="col-lg-7 col-md-6 col-sm-12">
                      <?php
                        ...
                        $set = $settings->get_settings_by_id($n); 
                             ?>
                <h2 style="font-size: 16px">  <i class="fa fa-pizza-slice mr-2"></i>Update <?php  echo "<i>". $set['title']. "</i> "  ?> Settings               
                </h2>
                         <?php } ?>
            </div>
        </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <?php $set = $settings->get_settings_by_id($id); ?>
                                <form action="../controller/update_settings?n=<?php echo $id; ?>" method="post" class="form-inline">
                                    <div class="col-lg-5 col-12">
                                        <div class="input-group">
                                            <span class="input-group-addon">
                                                <i class="zmdi zmdi-pizza"></i>
                                            </span>
                                            <input type="text" value=" <?php echo $set['definition'] ?>" name="definition" class="form-control" placeholder="Enter definition ">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-12">
                                        <div class="input-group">
                                            <button type="submit" name="settings_update" class="btn btn-raised btn-round btn-primary">Update Settings</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
